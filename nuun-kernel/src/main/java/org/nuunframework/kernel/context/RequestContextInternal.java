...
//    private final Map<Class<?> ,  Collection<Class<?>>> mapTypes;
     ...
     * 
     */
    public RequestContextInternal(String initialPropertiesPrefix  , Map<String,String> kernelParams)
    {
...
//        }
    ...
    private void initScanner()
    {
        ...
        this.classpathScanner = new ClasspathScannerFactory().create(rawArrays);
    }
